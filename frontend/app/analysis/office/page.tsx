...
import { ArrowLeft, Shield, AlertTriangle, FileSpreadsheet, Download, PieChart, BarChart, List } from "lucide-react"
...
export default function OfficeAnalysisPage() {
      ...
      <div className="flex min-h-screen flex-col">
        <main className="flex-1 flex items-center justify-center">
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-muted-foreground">Analyzing Office document...</p>
          </div>
        </main>
      </div>
    )
  ...
  const barChartData = data.indicators.map((indicator) => ({
    name: indicator.type,
    value: indicator.severity === "high" ? 3 : indicator.severity === "medium" ? 2 : 1,
      ...
      <div className="grid gap-6">
        <div className="flex flex-col md:flex-row md:items-center gap-4 justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Office Document Analysis Report</p>
          </div>
        ...
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="indicators">
            <div className="grid gap-6">
              <Card className="shadow-md">
                <CardHeader>
                  <CardTitle>Indicator Severity Distribution</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="h-64">
                    <ResponsiveContainer width="100%" height="100%">
                      <RechartsBarChart data={barChartData} layout="vertical" margin={{ left: 100 }}>
                        ...
                        <Tooltip
                          formatter={(value, name, props) => {
                            ...
                            return [severityMap[value as number], "Severity"]
                          }}
                        />
                        <Bar dataKey="value" name="Severity">
