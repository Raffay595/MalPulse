...
import { ArrowLeft, Shield, AlertTriangle, FileIcon, Download, PieChart, BarChart, List } from "lucide-react"
      ...
      <div className="grid gap-6">
        <div className="flex flex-col md:flex-row md:items-center gap-4 justify-between">
          <div>
            ...
            <p className="text-muted-foreground">PDF File Analysis Report</p>
          </div>
